...
<h2>Step 5:</h2> Create and Configure the Lambda Function (Lambda Function Name: TextToSpeechFunction)
<h2>Set the runtime to Python 3.8. Set the execution role with necessary permissions for S3 and Polly. (Step 4) Add Environment Variables (SOURCE_BUCKET: Name of your source S3 bucket and DESTINATION_BUCKET: Name of your destination S3 bucket. 
